<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WFC_A_Notification_V_Em.ascx.cs" 
    Inherits="JobSurfer.A_WebFormControl.WFC_A_Notification_V_Em" %>

<link href="../A_CSS/CSS_A_Notification_V_Em.css" rel="stylesheet" />
...
<div id="divA1_3">
    ...
    <asp:SqlDataSource ID="sql_DS_A1_3" runat="server" ConnectionString="Data Source=DESKTOP-NKM47LH\SQL_SERVER_TEST;Initial Catalog=TestDB;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="pull_EMPnotifications_p" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
