...
{
    public partial class WFC_A_Resources_Del_Doc_E : System.Web.UI.UserControl
    {
        ...
        {                                                                                                                                                       /* document ID is entered*/
            ...
            try
            {
                ...
                documentID_check_cmd.CommandText = "check_EMP_docResource_ID";
        ...
        protected void buttonA1_3_Click(object sender, EventArgs e)  /*remove button is clicked*/
        {
            ...
            if (check_documentID_flag == 1)    /*document id correct*/
            {
                try
                {
                    ...
                    delete_docResource_cmd.CommandText = "delete_EMP_docResource_ID";
