...
{
    public partial class WFC_A_Resources_Del_Vid_E : System.Web.UI.UserControl
    {
        ...
        {                                                                                                                                                       /* video ID is entered*/
            ...
            try
            {
                ...
                videoID_check_cmd.CommandText = "check_EMP_videoResource_ID";
        ...
        protected void buttonA1_3_Click(object sender, EventArgs e)   /*remove button is clicked*/
        {
            ...
            if (check_videoID_flag == 1)    /*video id correct*/
            {
                try
                {
                    ...
                    delete_videoResource_cmd.CommandText = "delete_EMP_videoResource_ID";
