...
{
    public partial class WFC_A_Message_V_Js_Details : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                message_id = Request.QueryString["id"];   /*pulling the job id from url*/

                pull_messages();   /*for pulling js messages from database*/
            }
        }

        protected void pull_messages()   /*for pulling js messages from database*/
        {
            ...
            try
            {
                ...
                pull_messages_cmd.CommandText = "view_JSmessages_p";
                ...
                if (pull_messages_rdr.HasRows)
                {
                    ...
                    {
                        textboxA1_3.Text = pull_messages_rdr.GetString(0);                        /*User Name*/
