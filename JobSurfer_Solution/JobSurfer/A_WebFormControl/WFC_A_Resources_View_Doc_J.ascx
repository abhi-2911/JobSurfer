<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WFC_A_Resources_View_Doc_J.ascx.cs" 
    Inherits="JobSurfer.A_WebFormControl.WFC_A_Resources_View_Doc_J" %>

<link href="../A_CSS/CSS_WFC_A_Resources_View_Doc_J.css" rel="stylesheet" />
...
<div id="divA1_3">
    ...
    <asp:SqlDataSource ID="sql_DS_A1_3" runat="server" ConnectionString="Data Source=DESKTOP-NKM47LH\SQL_SERVER_TEST;Initial Catalog=TestDB;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="list_js_doc_res" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
