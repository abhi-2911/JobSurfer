<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WFC_A_Message_S_Em.ascx.cs" 
    Inherits="JobSurfer.A_WebFormControl.WFC_A_Message_S_Em" %>

<link href="../A_CSS/CSS_WFC_A_Message_S_Em.css" rel="stylesheet" />


<div id="divA_3">

    <asp:Label CssClass="labelA_3" ID="labelA1_3" runat="server" Text="User Name" AssociatedControlID="textboxA1_3" ></asp:Label>
    <asp:TextBox CssClass="textboxA_3" ID="textboxA1_3" runat="server" CausesValidation="True" MaxLength="20" ToolTip="Enter Employer UserName"></asp:TextBox>
