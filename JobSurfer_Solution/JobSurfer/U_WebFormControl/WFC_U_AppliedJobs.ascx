<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WFC_U_AppliedJobs.ascx.cs" 
    Inherits="JobSurfer.U_WebFormControl.WFC_U_AppliedJobs" %>

<link href="../U_CSS/CSS_WFC_U_AppliedJobs.css" rel="stylesheet" />
...
<div id="divA1_3">
    ...
    <asp:GridView CssClass="gvA_3" ID="gvA1_3" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" OnSelectedIndexChanged="gvA1_3_SelectedIndexChanged">
        <Columns>
            <asp:TemplateField HeaderText="Job_ID" Visible="False">
                <ItemTemplate>
    ...
    <asp:Button CssClass="buttonA_3" ID="buttonA1_3" runat="server" Text=" Job Search " PostBackUrl="~/User/U_JobSearch.aspx" />
