<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WFC_U_Notification_Details.ascx.cs" 
    Inherits="JobSurfer.U_WebFormControl.WFC_U_Notification_Details" %>

<link href="../U_CSS/CSS_WFC_U_Notification_Details.css" rel="stylesheet" />
