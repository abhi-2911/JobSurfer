<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WFC_U_Notifications.ascx.cs" 
    Inherits="JobSurfer.U_WebFormControl.WFC_U_Notifications" %>

<link href="../U_CSS/CSS_WFC_U_Notifications.css" rel="stylesheet" />
