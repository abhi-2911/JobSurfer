<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WFC_U_Resource_V.ascx.cs" 
    Inherits="JobSurfer.U_WebFormControl.WFC_U_Resource_V" %>

<link href="../U_CSS/CSS_WFC_U_Resource_V.css" rel="stylesheet" />
