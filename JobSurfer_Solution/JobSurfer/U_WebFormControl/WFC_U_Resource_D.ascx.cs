...
{
    public partial class WFC_U_Resource_D : System.Web.UI.UserControl
    {
        ...
        protected void gvA1_3_SelectedIndexChanged(object sender, EventArgs e)  /*open button click in gridview*/
        {
            ...
            try
            {
                ...
                viewDoc_cmd.CommandText = "pull_js_doc_res";
                ...
                if (viewDoc_rdr.HasRows)
                {
                    ...
                    {
                        byte[] docData = (byte[])viewDoc_rdr["pdf_doc"];  /*JS Doc Resource pdf*/
