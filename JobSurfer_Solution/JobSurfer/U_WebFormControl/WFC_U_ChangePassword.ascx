<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WFC_U_ChangePassword.ascx.cs" 
    Inherits="JobSurfer.U_WebFormControl.WFC_U_ChangePassword" %>

<link href="../U_CSS/CSS_WFC_U_ChangePassword.css" rel="stylesheet" />
