<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WFC_E_Notifications.ascx.cs" 
    Inherits="JobSurfer.E_WebFormControl.WFC_E_Notifications" %>

<link href="../E_CSS/CSS_WFC_E_Notifications.css" rel="stylesheet" />
