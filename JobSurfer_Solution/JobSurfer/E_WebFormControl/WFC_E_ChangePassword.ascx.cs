...
{
    public partial class WFC_E_ChangePassword : System.Web.UI.UserControl
    {
        ...
        protected void check_password()   /*will pull old password at page load event*/
        {
            ...
            try
            {
                ...
                check_password_cmd.CommandText = "checkOldPassword_E_p";
                check_password_cmd.CommandType = CommandType.StoredProcedure;

                check_password_cmd.Parameters.AddWithValue("@userName", Session["employer"].ToString());
        ...
        protected void buttonA1_3_Click(object sender, EventArgs e)   /*Update Password button*/
        {
            if (min_char_password == 0)
            {
                if (check_e_password == textboxA1_3.Text.Trim())
                {
                    try
                    {
                        ...
                        update_password_cmd.CommandText = "update_E_Password_p";
                        update_password_cmd.CommandType = CommandType.StoredProcedure;

                        update_password_cmd.Parameters.AddWithValue("@userName", Session["employer"].ToString());   /*username from employer session*/
