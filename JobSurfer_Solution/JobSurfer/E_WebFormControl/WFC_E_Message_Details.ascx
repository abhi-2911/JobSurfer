<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WFC_E_Message_Details.ascx.cs" 
    Inherits="JobSurfer.E_WebFormControl.WFC_E_Message_Details" %>

<link href="../E_CSS/CSS_WFC_E_Message_Details.css" rel="stylesheet" />
