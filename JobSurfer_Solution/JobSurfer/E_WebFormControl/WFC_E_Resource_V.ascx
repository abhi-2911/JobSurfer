<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WFC_E_Resource_V.ascx.cs" 
    Inherits="JobSurfer.E_WebFormControl.WFC_E_Resource_V" %>

<link href="../E_CSS/CSS_WFC_E_Resource_V.css" rel="stylesheet" />
