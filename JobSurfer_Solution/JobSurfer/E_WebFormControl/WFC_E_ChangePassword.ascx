<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WFC_E_ChangePassword.ascx.cs" 
    Inherits="JobSurfer.E_WebFormControl.WFC_E_ChangePassword" %>

<link href="../E_CSS/CSS_WFC_E_ChangePassword.css" rel="stylesheet" />
