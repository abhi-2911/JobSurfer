<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WFC_E_PostJobs.ascx.cs" 
    Inherits="JobSurfer.E_WebFormControl.WFC_E_PostJobs" %>

<link href="../E_CSS/CSS_WFC_E_PostJobs.css" rel="stylesheet" />
...
<div id="divA1_3">
    ...
    <asp:RequiredFieldValidator CssClass="rfvA_3" ID="rfvA1_3" runat="server" ErrorMessage="Role Required" ControlToValidate="ddlA1_3" ForeColor="Red" InitialValue="0">*</asp:RequiredFieldValidator>
    ...
    <asp:RequiredFieldValidator CssClass="rfvD_3" ID="rfvD1_3" runat="server" ErrorMessage="Education Required" ControlToValidate="ddlB1_3" ForeColor="Red" InitialValue="0">*</asp:RequiredFieldValidator>
    ...
    <asp:Button CssClass="buttonA_3" ID="buttonA1_3" runat="server" Text="Post Job" OnClick="buttonA1_3_Click" />
